...
} from "./chunk-YN7MGRRZ.js";
import {
  DOCUMENT
} from "./chunk-7DCOEYZS.js";
import {
  ...
  ɵɵtextInterpolate,
  ɵɵviewQuery
} from "./chunk-HRYRAAPE.js";
import {
  require_operators
} from "./chunk-CYKQPHMU.js";
import {
  require_cjs
} from "./chunk-I3TEYH7O.js";
import "./chunk-232HTUFZ.js";
import {
  __toESM
...
var MatPaginatedTabHeader = class _MatPaginatedTabHeader {
  ...
  constructor(_elementRef, _changeDetectorRef, _viewportRuler, _dir, _ngZone, _platform, _animationMode) {
    ...
    this._stopScrolling = new import_rxjs3.Subject();
    ...
    _ngZone.runOutsideAngular(() => {
      (0, import_rxjs3.fromEvent)(_elementRef.nativeElement, "mouseleave").pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
        this._stopInterval();
      });
    });
  }
  ngAfterViewInit() {
    (0, import_rxjs3.fromEvent)(this._previousPaginator.nativeElement, "touchstart", passiveEventListenerOptions).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
      this._handlePaginatorPress("before");
    });
    (0, import_rxjs3.fromEvent)(this._nextPaginator.nativeElement, "touchstart", passiveEventListenerOptions).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
      this._handlePaginatorPress("after");
    });
  }
  ngAfterContentInit() {
    const dirChange = this._dir ? this._dir.change : (0, import_rxjs3.of)("ltr");
    ...
    (0, import_rxjs3.merge)(dirChange, viewportResize, resize, this._items.changes, this._itemsResized()).pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
      this._ngZone.run(() => {
  ...
  _itemsResized() {
    ...
    return this._items.changes.pipe(
      ...
      (0, import_operators2.switchMap)((tabItems) => new import_rxjs3.Observable((observer) => this._ngZone.runOutsideAngular(() => {
  ...
  _handlePaginatorPress(direction, mouseEvent) {
    ...
    this._stopInterval();
    (0, import_rxjs3.timer)(HEADER_SCROLL_DELAY, HEADER_SCROLL_INTERVAL).pipe((0, import_operators2.takeUntil)((0, import_rxjs3.merge)(this._stopScrolling, this._destroyed))).subscribe(() => {
      const {
        maxScrollDistance,
        distance
      } = this._scrollHeader(direction);
...
var MatTabBodyPortal = class _MatTabBodyPortal extends CdkPortalOutlet {
  constructor(componentFactoryResolver, viewContainerRef, _host, _document) {
    ...
    this._host = _host;
    this._centeringSub = import_rxjs3.Subscription.EMPTY;
    this._leavingSub = import_rxjs3.Subscription.EMPTY;
  }
  /** Set initial visibility or set up subscription for changing visibility. */
  ngOnInit() {
    super.ngOnInit();
    this._centeringSub = this._host._beforeCentering.pipe((0, import_operators2.startWith)(this._host._isCenterPosition(this._host._position))).subscribe((isCentering) => {
...
var MatTabBody = class _MatTabBody {
  ...
  constructor(_elementRef, _dir, changeDetectorRef) {
    this._elementRef = _elementRef;
    this._dir = _dir;
    this._dirChangeSubscription = import_rxjs3.Subscription.EMPTY;
    this._translateTabComplete = new import_rxjs3.Subject();
    ...
    this._translateTabComplete.pipe((0, import_operators2.distinctUntilChanged)((x, y) => {
...
var MatTabGroup = class _MatTabGroup {
  ...
  constructor(_elementRef, _changeDetectorRef, defaultConfig, _animationMode) {
    ...
    this._tabsSubscription = import_rxjs3.Subscription.EMPTY;
    this._tabLabelSubscription = import_rxjs3.Subscription.EMPTY;
  ...
  _subscribeToTabLabels() {
    ...
    this._tabLabelSubscription = (0, import_rxjs3.merge)(...this._tabs.map((tab) => tab._stateChanges)).subscribe(() => this._changeDetectorRef.markForCheck());
  }
...
var MatTabNav = class _MatTabNav extends MatPaginatedTabHeader {
  ...
  constructor(elementRef, dir, ngZone, changeDetectorRef, viewportRuler, platform, animationMode, defaultConfig) {
    super(elementRef, changeDetectorRef, viewportRuler, dir, ngZone, platform, animationMode);
    this._fitInkBarToContent = new import_rxjs3.BehaviorSubject(false);
    this.stretchTabs = true;
    this.disableRipple = false;
    this.color = "primary";
    this.disablePagination = defaultConfig && defaultConfig.disablePagination != null ? defaultConfig.disablePagination : false;
  ...
  ngAfterContentInit() {
    this._inkBar = new MatInkBar(this._items);
    this._items.changes.pipe((0, import_operators2.startWith)(null), (0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
...
var MatTabLink = class _MatTabLink extends InkBarItem {
  ...
  constructor(_tabNavBar, elementRef, globalRippleOptions, tabIndex, _focusMonitor, animationMode) {
    ...
    _tabNavBar._fitInkBarToContent.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((fitInkBarToContent) => {
